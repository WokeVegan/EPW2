...
_this_dir = pathlib.Path(os.path.dirname(os.path.realpath(__file__)))
DATABASE_PATH = os.path.join(_this_dir.parent.absolute(), 'database')
...
def get_platform_by_gid(gid: int):
...
PLATFORM_OBJECTS = {
    ...
    PlatformID.ATARI_8BIT_FAMILY: Platform("Atari 8Bit Family", "atari_8bit_family.json"),
    ...
    PlatformID.BANDAI_WONDERSWAN: Platform("Bandai Wonderswan", "bandai_wonderswan.json"),
    PlatformID.BANDAI_WONDERSWAN_COLOR: Platform("Bandai Wonderswan Color", "bandai_wonderswan_color.json"),
    PlatformID.CAPCOM_PLAY_SYSTEM_1: Platform("Capcom Play System 1", "capcom_play_system_1.json"),
    PlatformID.CAPCOM_PLAY_SYSTEM_2: Platform("Capcom Play System 2", "capcom_play_system_2.json"),
    PlatformID.CAPCOM_PLAY_SYSTEM_3: Platform("Capcom Play System 3", "capcom_play_system_3.json"),
    PlatformID.COMMODORE_64_PRESERVATION_PROJECT: Platform("Commodore 64 Preservation Project",
                                                           "commodore_64_preservation_project.json"),
    PlatformID.COMMODORE_64_TAPES: Platform("Commodore 64 Tapes", "commodore_64_tapes.json"),
    PlatformID.COMPLETE_ROM_SETS: Platform("Complete Rom Sets", "complete_rom_sets.json"),
    PlatformID.DREAMCAST: Dreamcast("Dreamcast", "dreamcast.json"),
    PlatformID.GAMECUBE: Platform("Gamecube", "gamecube.json"),
    PlatformID.GAME_BOY: Platform("Game Boy", "game_boy.json"),
    PlatformID.GAME_BOY_ADVANCE: Platform("Game Boy Advance", "game_boy_advance.json"),
    PlatformID.GAME_BOY_COLOR: Platform("Game Boy Color", "game_boy_color.json"),
    PlatformID.MAME: Platform("Mame", "mame.json"),
    PlatformID.NEO_GEO: Platform("Neo Geo", "neo_geo.json"),
    PlatformID.NEO_GEO_POCKET_NEO_GEO_POCKET_COLOR_NGPX: Platform("Neo Geo Pocket Neo Geo Pocket Color Ngpx",
                                                                  "neo_geo_pocket_neo_geo_pocket_color_ngpx.json"),
    PlatformID.NINTENDO_64: Platform("Nintendo 64", "nintendo_64.json"),
    PlatformID.NINTENDO_DS: Platform("Nintendo DS", "nintendo_ds.json"),
    PlatformID.NINTENDO_ENTERTAINMENT_SYSTEM: Platform("Nintendo Entertainment System",
                                                       "nintendo_entertainment_system.json"),
    PlatformID.NINTENDO_FAMICOM_DISK_SYSTEM: Platform("Nintendo Famicom Disk System",
                                                      "nintendo_famicom_disk_system.json"),
    PlatformID.NOKIA_NGAGE: Platform("Nokia Ngage", "nokia_ngage.json"),
    PlatformID.PANASONIC_3DO_3DO_INTERACTIVE_MULTIPLAYER: Platform("Panasonic 3Do 3Do Interactive Multiplayer",
                                                                   "panasonic_3do_3do_interactive_multiplayer.json"),
    PlatformID.PCFX: Platform("Pcfx", "pcfx.json"),
    PlatformID.PC_ENGINE_CD_TURBO_DUO_TURBOGRAFX_CD: Platform("Pc Engine Cd Turbo Duo Turbografx Cd",
                                                              "pc_engine_cd_turbo_duo_turbografx_cd.json"),
    PlatformID.PC_ENGINE_TURBOGRAFX16: Platform("Pc Engine Turbografx16", "pc_engine_turbografx16.json"),
    ...
    PlatformID.SEGA_GENESIS_SEGA_MEGADRIVE: Platform("Sega Genesis Sega Megadrive", "sega_genesis_sega_megadrive.json"),
    PlatformID.SEGA_MASTER_SYSTEM: Platform("Sega Master System", "sega_master_system.json"),
    ...
    PlatformID.SONY_PLAYSTATION: Platform("Sony Playstation", "sony_playstation.json"),
    PlatformID.SONY_PLAYSTATION_2: Platform("Sony Playstation 2", "sony_playstation_2.json"),
    PlatformID.SONY_PLAYSTATION_DEMOS: Platform("Sony Playstation Demos", "sony_playstation_demos.json"),
    PlatformID.SONY_POCKETSTATION: Platform("Sony Pocketstation", "sony_pocketstation.json"),
    PlatformID.SONY_PSP: Platform("Sony Psp", "sony_psp.json"),
    PlatformID.SUPER_NINTENDO_ENTERTAINMENT_SYSTEM: Platform("Super Nintendo Entertainment System",
                                                             "super_nintendo_entertainment_system.json"),
    PlatformID.VIRTUAL_BOY: Platform("Virtual Boy", "virtual_boy.json"),
    PlatformID.ZX_SPECTRUM_TAPES: Platform("Zx Spectrum Tapes", "zx_spectrum_tapes.json"),
    PlatformID.ZX_SPECTRUM_Z80: Platform("Zx Spectrum Z80", "zx_spectrum_z80.json")
}


def get_title(gid: int):
    for db in iter_platforms():
        print(db.title)


if __name__ == '__main__':
    p = Platform("Playstation", "sony_playstation.json")
